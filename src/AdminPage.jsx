...
function ListEditor({ title, description, items, onChange, setMessage, multiline = false, addLabel = "Add", collapsible = false }) {
  ...
  return <AdminCard title={title} description={description} collapsible={collapsible} actions={<button type="button" onClick={openAdd}><Plus /> {addLabel}</button>}>
...
function RecordEditor({ title, description, items, fields, createItem, onChange, setMessage, addLabel = "Add", allowVisibility = false, sectionVisible = true, onSectionVisibilityChange }) {
  ...
  return <AdminCard title={title} description={description} collapsible actions={<>{allowVisibility && <VisibilityToggle checked={sectionVisible} onChange={onSectionVisibilityChange} visibleLabel="Section visible" hiddenLabel="Section hidden" />}<button type="button" onClick={openAdd}><Plus /> {addLabel}</button></>}>
